...
class AnalyzerTests(unittest.TestCase):
    ...
    def test_meta_analysis_reports_weighted_field_position(self) -> None:
        ...
        self.assertEqual(len(analysis.meta_analysis["tournament_rows"]), 6)
        self.assertIn("Mega Charizard Y Aerodactyl", tournament_labels)
        self.assertIn("Mega Glimmora Offense", tournament_labels)
        self.assertNotIn("Sand Garchomp Balance", tournament_labels)
        self.assertNotIn("Hydrapple Grassy Balance", tournament_labels)
        self.assertNotIn("Ninetales-A Snow Room", tournament_labels)
    ...
    def test_text_report_includes_meta_preview_context(self) -> None:
        ...
        self.assertIn("Mega Charizard Y Aerodactyl", report)
        self.assertIn("Mega Glimmora Offense", report)
        self.assertNotIn("Sand Garchomp Balance", report)
        self.assertNotIn("Hydrapple Grassy Balance", report)
        self.assertNotIn("Ninetales-A Snow Room", report)
