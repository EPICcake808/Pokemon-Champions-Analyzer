...
// Validate ../../../src/app/api/builder-move/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/builder-move">> = Specific
  const handler = {} as typeof import("../../../src/app/api/builder-move/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/builder-species/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/builder-species">> = Specific
  const handler = {} as typeof import("../../../src/app/api/builder-species/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/meta-snapshot/deep-refresh/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/meta-snapshot/deep-refresh">> = Specific
  const handler = {} as typeof import("../../../src/app/api/meta-snapshot/deep-refresh/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../src/app/api/saved-teams/[teamId]/route.ts
{
  ...
  const handler = {} as typeof import("../../../src/app/api/saved-teams/[teamId]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/saved-teams/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/saved-teams">> = Specific
  const handler = {} as typeof import("../../../src/app/api/saved-teams/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
