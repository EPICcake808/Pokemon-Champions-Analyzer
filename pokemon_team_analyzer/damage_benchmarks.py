...
ATTACKER_BENCHMARKS: tuple[DamageBenchmark, ...] = (
    ...
    DamageBenchmark(
        ...
        note="Spread Ground pressure from a fast Soft Sand attacker.",
    ),
    DamageBenchmark(
        "nuke_basculegion_wave_crash",
        "Rain Mystic Water Basculegion Wave Crash",
        # Canonical form name the data provider can resolve (bare "Basculegion"
        # does not resolve via PokeAPI; the format defaults it to the male form).
        "Basculegion (Male)",
        "rain",
        _Spread(atk=32, spe=32, plus="attack"),
        ability="Swift Swim",
