...
# Maps each Mega Stone to the Mega Evolution species it produces. Kept here alongside
# ``MEGA_STONE_TO_BASE_SPECIES`` so all M-A rule data lives together; the regulations layer
# lowercases these when it compiles per-regulation lookups.
